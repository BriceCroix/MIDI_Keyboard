 ...
 */
extern uint8_t keys_0;

/**
 * \brief stores the previous state of the keys_0 variable
 */
extern uint8_t keys_0_last;
extern uint8_t keys_6;
extern uint8_t keys_6_last;
#if KEYS_NUMBER >= 12
extern uint8_t keys_12;
extern uint8_t keys_12_last;
#endif
#if KEYS_NUMBER >= 18
extern uint8_t keys_18;
extern uint8_t keys_18_last;
#endif
#if KEYS_NUMBER >= 24
extern uint8_t keys_24;
extern uint8_t keys_24_last;
#endif
#if KEYS_NUMBER >= 30
extern uint8_t keys_30;
extern uint8_t keys_30_last;
#endif
#if KEYS_NUMBER >= 36
extern uint8_t keys_36;
extern uint8_t keys_36_last;
#endif
#if KEYS_NUMBER >= 42
extern uint8_t keys_42;
extern uint8_t keys_42_last;
#endif
extern uint8_t buttons_settings;
extern uint8_t buttons_settings_last;

/**
 * \brief index of the lowest key, 0 for C0, 2 for D0, 12 for C1...
 */
extern int8_t pitch_0;
